                ...
                <div class="row-3-grid" style="gap: 20px">
                    ...
                    <div>
                        <table class="collapse-table">
                            ...
                            <c:forEach var="order" items="${sessionScope.customerrequests}">
                                    ...
                                    <tr>
                                        ...
                                        <th><h3>${order.status}</h3></th>
                                            ...
                                            <form action="${pageContext.request.contextPath}/fc/acceptoffercommand"
                                                ...
                                                <c:if test="${order.status.equals('offer')}">
                                                <th><input type="submit" value="Accept" class="purple-button"
                                                           style="padding: 10px 10px; width: 85px; background-color: #00D555">
                                                </th>
                                                </c:if>
                                            </form>
