                        ...
                        <form action="${pageContext.request.contextPath}/fc/requestcommand" method="post">
                            <div class="row-3-grid">
                                ...
                                <div class="row-2-grid" style="gap: 20px">
                                    ...
                                    <div>
                                        <input type="text" value="${sessionScope.makeoffer.totalPrice}">
                                        <input type="text" value="${sessionScope.makeoffer.totalCost}">
                                        <input type="text" value="${sessionScope.makeoffer.coverageRatio}">  <%--todo: update in realtime aka javascript--%>
                                    </div>
