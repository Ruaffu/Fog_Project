                                ...
                                <div class="col-xs-12">
                                    <form action="${pageContext.request.contextPath}/fc/requestcommand" method="post">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12">
                                                    <div style="margin-bottom: 15px">
                                                        <input type="radio" id="flatroof" name="choosenroof"
                                                               value="flatroof">
                                                ...
                                                <div class="col-xs-12">
                                                    <div>
                                                        <input type="radio" id="angleroof" name="choosenroof"
                                                               value="angleroof">
                                        ...
                                        <div>
                                            <div class="row">
                                                <div class="col-xs-3">
                                                    <a href="${pageContext.request.contextPath}" class="grey-button">
                                                        Fortryd </a>
                                                </div>
                                                <div class="col-xs-3">
