                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="xhtml-string">
                            <c:if test="${sessionScope.allrequests.size() == 0}">
                                            ...
                                            <td>
                                                <c:if test="${request.status.equals('request')}">
                                                    <form action="${pageContext.request.contextPath}/fc/makeoffercommand"
                                                        ...
                                                        <input type="hidden" name="listname" value="allrequests">
                                                ...
                                                <c:if test="${request.status.equals('offer')}">
                                                    <form action="${pageContext.request.contextPath}/fc/getrequestcommand" method="post">
